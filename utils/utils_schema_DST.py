...
class SchemaProcessor(DialogProcessor):
    ...
    def process_dialogue(self, dialogue_dict):
        """
        ...
        def combine_turns(user_turn, system_turn):
            ...
            for elem in turn_belief:
                ...
                slot_idx = self.ALL_SLOTS.index("-".join([domain, slot]))
    ...
    def process_all_dialogues(self, directory):
        """
        ...
        for file_path in file_paths:
            with open(file_path) as f:
                ...
                for dialogue_dict in dialogue_dicts:
                    temp_data, dialogue_length = self.process_dialogue(dialogue_dict)
...
def prepare_data_seq_schema(training, sequicity):
    ...
    #     pair_dev, dev_max_len = process_all_dialogues(dev_dialogues_dir)
