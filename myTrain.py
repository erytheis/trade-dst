...
from utils.utils_dataset_processor import prepare_data_seq
...
def run_training():
    ...
    train, dev, test, test_special, lang, SLOTS_LIST, gating_dict, max_word = prepare_data_seq(True, False)
